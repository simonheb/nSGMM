...
simulate_BBP_cpp0 <- function(n, delta0, delta1, sigma, distance, kinship, capacity, income, reps, seed, rounds) {
    .Call(`_nSGMM_simulate_BBP_cpp0`, n, delta0, delta1, sigma, distance, kinship, capacity, income, reps, seed, rounds)
}
